...
public class Dungeon {
	 ...
	 */
	public Dungeon(String name, Location start, List<Item> reward, String creator, Difficulty difficulty, int timesCompleted){
		this.name = name;
		this.start = start;
		this.reward = reward;
	...
	public void setReward(List<Item> reward) {this.reward = reward;}
